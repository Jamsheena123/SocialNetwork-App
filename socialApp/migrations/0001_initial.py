# Generated by Django 5.1 on 2024-09-18 22:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user1', 'user2'), name='unique_friendship'), models.UniqueConstraint(fields=('user2', 'user1'), name='reverse_unique_friendship')],
