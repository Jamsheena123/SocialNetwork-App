...
SECRET_KEY = 'django-insecure-%t(!#u^(4022oaa1dyo-36m)31+u&%uz&+iq^p2^lq(bz9e!t1'
...
# Optional: Set a default cache timeout
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        ...
        'user': '5/minute',
        'login': '10/minute',
        'friend_request': '5/minute',
    },

}

AUTHENTICATION_BACKENDS = [
    'socialApp.authenticate.EmailBackend',  # Path to your custom backend
